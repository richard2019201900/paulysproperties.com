...
function buildContractText(c){
    ...
    t+='    SELLER:    '+d.seller+'\n';
    t+='    BUYER:     '+d.buyer+'\n';
    t+='    PRICE:     $'+d.price.toLocaleString()+' ('+d.term+' month term)\n';
...
window.copyAllAuditText=function(){
    ...
    ft+='║             Generated: '+now.toLocaleString('en-US',{month:'short',day:'numeric',year:'numeric',hour:'numeric',minute:'2-digit',hour12:true}).padEnd(37)+'║\n';
    ft+='╚══════════════════════════════════════════════════════════════╝\n\n';
    ft+='────────────────────────────────────────────────────────────────\n';
    ft+='  PORTFOLIO SUMMARY\n';
    ft+='────────────────────────────────────────────────────────────────\n\n';
    ft+='  '+T.n+' total RTO contracts\n';
